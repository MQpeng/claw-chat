...
// Fixed base58 encoder (same alphabet as bitcoin/base58)
...
void main() async {
  ...
  print('=== Testing OpenClaw connection with fixed base58 implementation ===');
  ...
  print('publicKey base58: ${base58Encode(publicKeyBytes)}');
  ...
  channel.stream.listen(
    (data) {
      ...
      if (frame['type'] == 'event' && frame['event'] == 'connect.challenge') {
        ...
        // Sign the challenge
        _signAndSend(channel, deviceId, publicKeyBytes, base58Encode(publicKeyBytes), challengeNonce, token, keyPair);
        return;
      }
